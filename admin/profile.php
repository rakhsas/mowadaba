...
.card-content{
                ...
                <div class="col s12 m12 l12">
                    <div class="card">
                        <div class="card-image">
                            <img src="../images/fb_cover5.jpg" alt="" class="responsive-img "  style="height:250px;" >
                        </div>
                                ...
                                <!-- Starting Post Printing Code From Here  -->
                                    ...
                                    <div class="card">
                                        <div class="row" style="padding: 12px; padding-bottom: 0px; margin-top: -20px;">
                                            ...
                                            <ul id='dropdown' class="dropdown-content" style="cursor:pointer">
                                                <li><a href="#">Edit</a></li>
    ...
    <?php //require_once('../include/profile_sidenav.php');?>
