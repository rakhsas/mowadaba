...
<?php require_once('../include/students/sidenavstudent.php.php'); ?>
            ...
            <div class="col s12 m4 l3 sidebar" style="margin-top: -100px;">
                    ...
                    <img src="../img/<?php
                        ...
                        <div class=" col l12 white-text brown lighten-1">
                            <h5>About Me!</h5>
                            <p>Hi! I'm <?php echo $name; ?>, I'm 18 years old, living in Sarai Meer. I am a college student
...
Media, Software Engineering, and Data Science in Sarai Meer.</p>
            ...
            <div class="col s12 m12 l3 hide-on-med-and-down">
             <h5 class="left">Who to follow</h5>
                ...
                ?>      
                        <div class="col l6">
                            <div class="card"style=" border-bottom-left-radius:10%;border-top-right-radius:10%;" >
                                <a href="?u=<?php echo $id; ?>">
                                    <div class="card-image">
                                        <img  src="../img/<?php 
                                         if (isset($image) && !empty($image)){
                                            echo $image;
                                           ...
                                           {
                                             echo "user.png";
                                           }?>" alt="" style=" border-bottom-left-radius:10%;border-bottom-right-radius:10%; margin-bottom:-20%;" class=" responsive-img">
